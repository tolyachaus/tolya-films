          ...
          >
            ...
            <div className="space-y-6 text-gray-700 font-light text-lg leading-relaxed">
              <p>
                ...
                <span className="text-brand-dark font-medium"> gesehen, gehört und wiedererkannt</span> zu werden.
              ...
              <div className="p-6 bg-brand-gray border-l-2 border-brand-gold backdrop-blur-sm">
                <h3 className="text-brand-dark font-display text-xl uppercase tracking-widest mb-2">Was ich mache</h3>
                <p>
                  Ich filme und schneide Videos. Neben dem Video bin ich auch Musiker – das gibt mir ein besonderes Gefühl für
                  <span className="text-brand-dark font-medium"> Rhythmus, Sound und Stimmung</span> im Bild.
                </p>
              </div>
