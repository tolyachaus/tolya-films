          ...
          <div className="col-span-1">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                aria-label="WhatsApp"
                className="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center text-white hover:bg-green-600 hover:scale-110 transition-all duration-300 shadow-md"
              >
