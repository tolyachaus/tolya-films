          ...
          <div className={`hidden md:flex items-center space-x-12 ${desktopTextColor}`}>
            ...
            <div className={`flex items-center gap-3 pl-4 border-l ${isScrolled && !isMobileMenuOpen ? 'border-brand-dark/20' : 'border-white/20'}`}>
              <a
                ...
                aria-label="WhatsApp"
                className={`flex items-center gap-2 px-3 h-9 rounded-full transition-all duration-300 shadow-md hover:scale-105 ${isScrolled && !isMobileMenuOpen ? 'bg-gray-100 text-brand-dark hover:bg-gray-200' : 'bg-white/10 text-white hover:bg-white/20'}`}
              >
            ...
            <div className="flex flex-col items-center space-y-8 w-full px-6 text-white text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-8 pt-8 border-t border-white/10 w-full max-w-sm">
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  className="px-6 h-12 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 hover:scale-105 transition-all duration-300 shadow-md gap-3"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                  <span className="text-lg font-medium tracking-wide">{SOCIAL_LINKS.phone}</span>
                </a>
                <a
                  href={SOCIAL_LINKS.instagram}
                  target="_blank"
